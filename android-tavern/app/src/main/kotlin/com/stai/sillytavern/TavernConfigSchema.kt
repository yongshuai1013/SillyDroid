...
internal enum class TavernConfigFieldKind {
    BOOLEAN,
    TEXT,
    MULTILINE_TEXT,
    INTEGER,
...
internal data class TavernConfigFieldSpec(
    val path: String,
    val title: String,
    val summary: String,
...
internal data class TavernConfigSectionSpec(
    val title: String,
    val summary: String,
    val fields: List<TavernConfigFieldSpec>
)

internal object TavernConfigSchema {
    ...
    val sections: List<TavernConfigSectionSpec> = listOf(
        TavernConfigSectionSpec(
            ...
            fields = listOf(
                integerField("port", "启动端口", "宿主 WebView 和本地服务都会使用这个端口。", BootConfig.defaultServicePort),
